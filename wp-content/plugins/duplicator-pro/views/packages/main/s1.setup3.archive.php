...
<div class="dup-box-panel" id="dup-pack-archive-panel" style="<?php echo $ui_css_archive ?>">
	...
	<div data-dpro-tabs="true">
		<ul>
			...
			<li style="<?php echo $display_network ? '' : 'display:none'?>"><a href="javascript:void(0)"><?php DUP_PRO_U::_e('Multisite') ?></a></li>
		</ul>
		...
		<div style="<?php echo $display_network ? '' : 'display:none'?>">
			...
			<?php
				...
				$txt_mu_basic   = DUP_PRO_U::__("which backs up and migrates an entire multisite network. "
					. "Subsite to standalone conversion is not supported with Multisite Basic, only with Multisite Plus+.  To gain access to Multisite Plus+ "
					. "please login to your dashboard and upgrade to either a <a href='https://snapcreek.com/dashboard/' target='snap'>Business or Gold License</a>.");
			...
			<table style="display:none" class="mu-opts">
				<tr>
					<td>
			...
			<div style="display:none" class="dpro-panel-optional-txt" style="text-align: left">
