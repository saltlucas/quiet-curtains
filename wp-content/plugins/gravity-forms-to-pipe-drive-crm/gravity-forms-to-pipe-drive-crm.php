...
$_wpgf2pdcrm_sell_page = 'http://helpforwp.com/downloads/gravity-forms-to-pipe-drive-crm/';
...
class WPGravityFormsToPipeDriveCRM {
	...
	public function __construct() {
		...
		$this->_wpgf2pdcrm_fields_by_group['People']['email'] = array('label' => 'Person - eMail', 'type' => 'string', 'description' => 'The email address for a new person record.');
		$this->_wpgf2pdcrm_fields_by_group['People']['phone'] = array('label' => 'Person - Phone', 'type' => 'string', 'description' => 'The phone number for a new person record.');
	...
	function wpgf2pdcrm_activate_license() {
		...
		if( isset( $_POST['wpgf2pdcrm_license_activate'] ) ) {
			...
			// Call the custom API.
			$response = wp_remote_get( add_query_arg( $api_params, $_wpgf2pdcrm_home_url ), array( 'timeout' => 15, 'sslverify' => false ) );
